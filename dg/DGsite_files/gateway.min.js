...
productConfig.trigger = ({
  ...
  "check": function() {
    ...
    config = {
      version: "19.0.33",
      id: "mBOO6bv+GU74oAFf9ilpQQ==",
      site_id: "domesticandgeneral",
      ...
      inviteExclude: {
        urls: [/\/webapp\/wcs\/stores\/servlet\/GuestPolicyDetailDisplayView/i, /\/PolicyDetailDisplayView/i, /\/webapp\/wcs\/stores\/servlet\/PaymentDisplayView/i],
        referrers: [],
        userAgents: [],
        browsers: [],
        cookies: [],
      ...
      cpps: {
        ...
        GA_UID: {
          ...
          value: function() {
            var e = "";
            return "undefined" != typeof ga && null != ga && "function" == typeof ga.getAll && null != ga.getAll()[0] && (e += ga.getAll()[0].get("clientId")), e
          }
        }
      }
    };
    surveydefs = [{
      ...
      display: {
        desktop: [{
          ...
          dialog: {
            headline: "<b>WE'D LOVE TO HEAR FROM YOU</b>",
            blurb: "Thank you for visiting our site. At the end of your visit please fill in a brief survey and let us know how we can improve your experience.",
            ...
            onexitblurb: "Please provide your email address. After your visit we'll send you a link to the survey.",
            ...
            onexitinvalidFormatErrorText: "Format should be: name@domain.com"
          }
        }],
        mobile: [{
          displayname: "default",
